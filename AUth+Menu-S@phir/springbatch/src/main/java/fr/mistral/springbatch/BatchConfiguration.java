package fr.mistral.springbatch;
...
import fr.mistral.springbatch.domain.User;
...
//    }
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName("org.postgresql.Driver");
        dataSource.setJdbcUrl("jdbc:postgresql://localhost:5432/Batch");
        dataSource.setUsername("postgres");
        dataSource.setPassword("root");
    ...
    public StaxEventItemReader<User> reader(){
        ...
        aliases.put("user", "fr.mistral.springbatch.User");
